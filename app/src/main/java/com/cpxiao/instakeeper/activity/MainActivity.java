package com.cpxiao.instakeeper.activity;
...
import com.cpxiao.instakeeper.adaptor.TabPagerAdapter;
import com.cpxiao.instakeeper.service.ClipBoardService;
...
//        drawer.setDrawerListener(toggle);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_instagram) {
            ViewClick.openApp(getApplicationContext(), "com.instagram.android");
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_rate_app) {
            ViewClick.rateApp(context);
        } else if (id == R.id.nav_share) {
            ViewClick.shareApp(context);

            //        } else if (id == R.id.nav_feedback) {

            //        } else if (id == R.id.nav_recommend_videos_to_us) {
